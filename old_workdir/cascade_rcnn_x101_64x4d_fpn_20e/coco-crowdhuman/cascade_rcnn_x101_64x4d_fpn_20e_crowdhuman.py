...
resume_from = 'pretrained/cascade_rcnn_x101_64x4d_fpn/cascade_rcnn_x101_64x4d_fpn_20e_coco_20200509_224357-051557b1.pth'
workflow = [('train', 1)]
classes = ('person', )
total_epochs = 8
work_dir = 'checkpoint/cascade_rcnn_x101_64x4d_fpn_20e/coco-crowdhuman'
gpu_ids = range(0, 1)
